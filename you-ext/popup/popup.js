function processQuestion() {
    ...
    // function qa(tabs){
    //     browser.tabs.sendMessage(tabs[0].id, {hi:'hello!'})
    // }
    ...
    function qa(tabs) {
        browser.tabs.sendMessage(tabs[0].id, {hi:'hello!', question: question})
    ...
    browser.tabs.query({active: true, currentWindow: true}).then(qa).catch(reportError);
}
  
  browser.tabs.executeScript({file: "/content_scripts/youtf.js"})
